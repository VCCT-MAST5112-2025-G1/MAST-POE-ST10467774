...
All pricing is displayed in South African Rands (R) to reflect the local market, but there are also options to use other currencies if it is convenient for the user.
...
* You can clear stored data by uninstalling the app.
  ...
  <!-- Example screenshot: Replace with your own images -->
  ![Home Screen](screenshots/home_screen.png)
  ## 10. Changelog

  * Initial release - no changes documented yet.
  ![Menu Details](screenshots/menu_details.png)
  ...
  References will be added in future updates.
